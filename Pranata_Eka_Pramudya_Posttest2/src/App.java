    ...
    public static void main(String[] args) throws IOException {
        ...
        while (true)
        {
            ...
            switch(pilihan)
            {
                ...
                {
                    System.out.println("============================================");
                    System.out.println(">>>> || Nama Barang     : "+ gtr.get(i).getNama());
                    System.out.println(">>>> || Kategori Barang : "+ gtr.get(i).getKategori());
                    System.out.println(">>>> || Stok Barang     : "+ gtr.get(i).getStok());
                    System.out.println(">>>> || Kode Barang     : "+ gtr.get(i).getKode());
                    System.out.println(">>>> || Harga Barang    : "+ gtr.get(i).getHarga());
                    System.out.println("=============================================");
                }
                break;
                ...
                for (Gitar gitar : gtr)
                {
                    if (gitar.getKode().equals(code_barang))
                    {
                        System.out.print(">>>> || Nama Barang :  ");
                ...
                {
                    if(gtr.get(i).getKode().equals(kodebarang))
                    {
                        gtr.remove(i);
                        break;
                    }
